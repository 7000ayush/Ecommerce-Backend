...
public class UserController {
	...
	public String loadCartPage(Principal p, Model m) {
		...
		UserDtls user = getLoggedInUserDtls(p);
	...
	private UserDtls getLoggedInUserDtls(Principal p) {
	...
	UserDtls loginUser = getLoggedInUserDtls(p);
	...
	public String changePassword(@RequestParam String newPassword,@RequestParam String currentPassword,Principal p,HttpSession session) {
		...
		UserDtls loggedInUserDtls = getLoggedInUserDtls(p);
		...
		if (matches) {
			...
			if (ObjectUtils.isEmpty(updateUser)) {
				session.setAttribute("errorMsg", "Password Not Updated!!Something went wrong.....");
			}else {
				session.setAttribute("succMsg", "Password Updated.....");
			}
			
		}else {
			session.setAttribute("errorMsg", "Password Not Matched.....");
		}
