...
public class AdminController {
	...
	@GetMapping("/category")
	public String category(Model m,@RequestParam(name = "pageNo", defaultValue = "0")Integer pageNo,@RequestParam(name = "pageSize",
...
//		m.addAttribute("categorys", categoryService.getAllCategory());
	...
	public String saveCategory(@ModelAttribute Category category,@RequestParam("file") MultipartFile file,HttpSession session) throws IOException {
		...
		if (existCategory) {
			...
			if (ObjectUtils.isEmpty(saveCategory)) {
				...
				session.setAttribute("errorMsg", "Not Saved!..Something Went wrong");
	...
	public String updateCategory(@ModelAttribute Category category, @RequestParam("file") MultipartFile file,HttpSession session) throws IOException {
		...
		if (!ObjectUtils.isEmpty(category)) {
			...
			oldCategory.setActive(false);//error//
...
//				System.out.println(path);
	...
	public String changePassword(@RequestParam String newPassword, @RequestParam String currentPassword, Principal p,
			HttpSession session) {
		UserDtls loggedInUserDetails = commonUtil.getLoggedInUserDtls(p);
